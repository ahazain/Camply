...
<body>
    <div class="container">
        <form id="formPesanan">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <div class="radio-group">
                            <label>
                                <input type="radio" name="ukuran_produk" value="L" /> L
                            </label>
                            <label>
                                <input type="radio" name="ukuran_produk" value="XL" /> XL
                            </label>
                            <label>
                                <input type="radio" name="ukuran_produk" value="XXL" /> XXL
                            </label>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="2"><button type="button" onclick="simpanData()">Beli</button></td>
                </tr>
            </table>
    ...
    <script>
        function simpanData() {
            ...
            $.ajax({
                type: "POST",
                url: "<?= BASEURL ?>/view/order/proses.php",
                data: dataForm,
